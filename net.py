...
class EdgeHead(nn.Module):
    """
    Small conv head predicting 1-channel edge logits from concatenated high-frequency features.
    """
...
class SAFNet(nn.Module):
    def __init__(self, num_res=8, base_channel=32, embed_dim=128, **kwargs):
        """
        ...
        # frequency embedding head and edge head
        # they take aggregated high-frequency maps; choose input channels = base_channel*4 (deepest)
    ...
    def forward(self, x):
        ...
        # optionally upsample edges to full res later by caller
...
if __name__ == "__main__":
    ...
    from loss import cod_loss

    # loss = cod_loss(y, gt_mask)
    # print(loss)
